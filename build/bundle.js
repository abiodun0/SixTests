...
/***/ function(module, exports, __webpack_require__) {
	...
	var _exam = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseComponent = _vue2.default.extend({
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SingleExamComponent = exports.ListExamComponent = undefined;
	...
	var _single = __webpack_require__(9);
	...
	var ListExamComponent = _vue2.default.extend({
	  ...
	  methods: {
	    showCreateModal: function showCreateModal(event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseRef = _db2.default.ref('exams');
	...
	var Exam = {
	  ...
	  create: function create(exam, cb) {
	    var key = baseRef.push().key();
	    var createdExam = baseRef.child(key).set(exam);
	    cb(createdExam);
	  },
